  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: colors.paper }}
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <Pressable onPress={openCopilot} style={{ flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: colors.accent, borderRadius: 11, paddingHorizontal: 14, minHeight: 40, justifyContent: 'center' }}>
